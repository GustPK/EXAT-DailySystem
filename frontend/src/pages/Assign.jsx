                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="sm:col-span-2 flex justify-center">
                        <button
                            type="submit"
                            disabled={loading}
                            className={`mb-6 w-38 h-11 text-white font-semibold rounded-xl shadow-lg transition-all duration-200 text-lg cursor-pointer tracking-wide border-2 ${loading
                                ? 'bg-gray-400 cursor-not-allowed border-gray-500'
                                : 'bg-gradient-to-r from-[#1e3a8a] to-[#2563eb] hover:shadow-2xl hover:scale-102 border-blue-800'
                                }`}
                        >
